...
public class AppointmentService {
    ...
    @Transactional
    public AppointmentResponseDto createNewAppointment(com.codingshuttle.youtube.hospitalManagement.dto.CreateAppointmentRequestDto createAppointmentRequestDto) {
